...
class Flickrdl:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Flickr Metadata Downloader')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'Flickrdl')
        self.toolbar.setObjectName(u'Flickrdl')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Flickrdl', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/flickrdl/icon.png'
        self.add_action(
            icon_path,
